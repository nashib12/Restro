...
const Room = () => {
    const roomList = [
        {id : 1, img : RoomImg1, marginTop : "mt-4 ", title : "Beachfront Bungalow", price : "$1000", originalPrice : "", beds : "2 Beds", people : "4 People"},
        {id : 2, img : RoomImg6, marginTop : "mt-4 md:mt-168", title : "Mountain View Queen Room", price : "$550", originalPrice : "", beds : "2 Beds", people : "4 People"},
        {id : 3, img : RoomImg4, marginTop : "mt-4 ", title : "Honeymoon Pool Villa", price : "$400", originalPrice : "$440", beds : "1 Bed", people : "2 People"},
        {id : 4, img : RoomImg5, marginTop : "mt-4 md:mt-168", title : "Luxury King Room", price : "$600", originalPrice : "", beds : "2 Beds", people : "4 People"},
        {id : 5, img : RoomImg8, marginTop : "mt-4 ", title : "Standard Double Room", price : "$500", originalPrice : "$550", beds : "2 Beds", people : "4 People"},
        {id : 6, img : RoomImg7, marginTop : "mt-4 md:mt-168", title : "Presidential Sea View Suite", price : "$900", originalPrice : "$999", beds : "2 Beds", people : "4 People"},
        {id : 7, img : RoomImg3, marginTop : "mt-4 ", title : "Garden Suite with Balcony", price : "$280", originalPrice : "$330", beds : "1 Bed", people : "2 People"},
        {id : 8, img : RoomImg2, marginTop : "mt-4 md:mt-168", title : "Deluxe Ocean View Room", price : "$320", originalPrice : "$370", beds : "1 Bed", people : "2 People"},
    ];
                            ...
                            <div key={room.id} className={`${room.marginTop} h-80 md:h-160 w-full  relative group`}>
                                ...
                                <div className='absolute bottom-2 m-2 md:m-6 text-white '>
                                    ...
                                    <div className='border-t border-white py-2 md:py-4 md:mt-4'>
                                        <button className='cursor-pointer border border-white h-8 md:h-12 w-36 flex items-center justify-center md:text-lg'>View Details</button>
