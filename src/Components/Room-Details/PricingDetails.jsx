  ...
  return (
    <div className='md:sticky top-8 bg-[#153E4D] text-white px-6 md:px-10 py-8 flex flex-col gap-2 h-230'>
      ...
      <div className='flex items-center justify-center gap-2 border-y border-white py-4 my-12'>
            ...
            <p className='tracking-wider text-5xl'>$1000</p>
            <p>/ Per Night</p>
      </div>
      ...
      <button className='mt-3 flex items-center justify-center w-full h-16 cursor-pointer border-black bg-white text-3xl uppercase text-black'>Book Now</button>
    </div>
  )
}
